using REAC_LockerDevice;
using System;
using System.Collections.Generic;
using System.IO;
using System.Text;

namespace REAC_LockerDevice.Utils.Output
{
    class Logger
    {
        ...
        private static void Write(string formattedText, string unformattedText)
        {
            lock (n)
            {
                try
                {
                    using (StreamWriter outputFile = File.AppendText("log/locker-" + Program.InitStartUTC.ToString("yyyy-MM-dd_HH-mm-ss") + ".log"))
                    {
